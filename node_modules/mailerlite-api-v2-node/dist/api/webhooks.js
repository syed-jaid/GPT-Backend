...
function default_1(client) {
    return {
        getWebhooks: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getWebhooksRaw()];
                        case 1:
                            webhooks = (_a.sent()).webhooks;
                            return [2 /*return*/, webhooks];
                    }
                });
            });
        },
        ...
        updateWebhook: function (webhookId, webhook) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        removeWebhook: function (webhookId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
