...
function default_1(client) {
    return {
        ...
        hasEnabledDoubleOptin: function () {
            return __awaiter(this, void 0, void 0, function () {
                var status;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getDoubleOptinStatus()];
                        case 1:
                            status = _a.sent();
                            return [2 /*return*/, status.enabled];
                    }
                });
            });
        },
        setDoubleOptin: function (isEnabled) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
